...
class NormaliseSpecEdgeCasesTest extends TestCase
{
    public function testNormalisesGitWithExtraSpaces(): void
    {
        ...
        $this->assertEquals('git/dev', \normaliseSpec('  git    dev  '));
    }
